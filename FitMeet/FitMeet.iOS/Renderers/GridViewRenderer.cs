...
namespace FitMeet.iOS.Renderers
{
    ...
    public class GridViewRenderer : ViewRenderer<GridView, GridCollectionView>
    {
        ...
        private void ElementPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            {
                if (this.Element.ItemsSource is INotifyCollectionChanged newItemsSource)
                {
        ...
        private void ElementPropertyChanging(object sender, PropertyChangingEventArgs e)
        {
            ...
            {
                if (this.Element.ItemsSource is INotifyCollectionChanged oldItemsSource)
                {
